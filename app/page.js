        ...
        <Box className='formation'>
          ...
          {activeTab === 0 && (
            <div className='formation__row-container'>
              <FormationElement href="/projets/kusmi-tea" titre="Intégratrice Web" entreprise="Kusmi Tea / alternance" duree="2023 - 2024" />
              <FormationElement href="/projets/etam" titre="Intégratrice Web" entreprise="Etam / alternance" duree="2021 - 2023" />
            </div>
          )}
